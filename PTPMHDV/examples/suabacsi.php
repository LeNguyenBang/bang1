    ...
    <div class="main-panel">
        ...
        <nav class="navbar navbar-expand-lg " color-on-scroll="500">
            <div class=" container-fluid  ">
                <a class="navbar-brand" href="#pablo"> Bệnh nhân/Chỉnh sửa hồ sơ bác sĩ</a>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <form action="xulysuabacsi.php" name="bacsi" method="post">
                                ...
                                <div class="author">
                                    <form>
                                        <a href="quanlybenhnhan.html">
                                            <img class="avatar border-gray" src="../assets/img/faces/bacsi1.jpg" alt="...">
